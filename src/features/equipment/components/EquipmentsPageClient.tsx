...
import { Plus, Pencil, Trash2, X, Settings, ArrowLeft } from 'lucide-react'
...
export function EquipmentsPageClient({ role }: { role: Role }) {
    ...
    if (selectedEquipment) {
        return (
            <div className="p-4 flex flex-col h-[calc(100vh-4rem)] min-h-0 space-y-3">
                ...
                <div className=" bg-surface border border-foreground/10 overflow-hidden shadow-card flex flex-col flex-1 min-h-0">
    ...
    return (
        <div className="p-4 space-y-3">
            <div className="flex justify-between items-center">
                <h1 className="text-[20px] font-bold uppercase tracking-widest text-foreground flex items-center gap-2">
                    <Settings className="w-6 h-6 text-accent" />
                    Equipments
                </h1>
            ...
            <div className="flex flex-wrap justify-center gap-3">
                {equipments.map(equipment => (
                    ...
                    >
                        ...
                        <h3 className="text-[20px] font-semibold text-foreground mb-2">{equipment.name}</h3>
